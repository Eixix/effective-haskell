...
module HaskellBook.Examples.UserInfo (User, lookupUser, authenticate, getUserName, getUserScore, getUserEmailAddress) where
    ...
    porter =
      User
        { userName = "porter",
          ...
          userEmailAddress = "woofoo@example.com"
        }
